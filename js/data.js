...
const MONUMENTS = [
  ...
  // ===================================================================
  // Little secrets — the things most visitors walk straight past
  // ===================================================================
  { id: "keyhole",     name: "The Aventine Keyhole",       type: "gate", secret: true, lat: 41.8834, lng: 12.4795, era: 8, status: "standing", date: "1765", blurb: "Peer through the keyhole of the Knights of Malta's priory and St Peter's dome appears perfectly framed by a garden hedge — Rome's most magical secret view.", wiki: "https://en.wikipedia.org/wiki/Santa_Maria_del_Priorato" },
  { id: "pasquino",    name: "Pasquino",                   type: "statue", secret: true, lat: 41.8981, lng: 12.4719, era: 8, status: "standing", date: "since 1501", blurb: "A battered ancient torso by Piazza Navona — Rome's first 'talking statue'. For 500 years Romans have stuck anonymous satires and complaints to its base.", wiki: "https://en.wikipedia.org/wiki/Pasquino" },
  { id: "capuchincrypt", name: "Capuchin Crypt",           type: "church", secret: true, lat: 41.9047, lng: 12.4886, era: 8, status: "standing", date: "1631", blurb: "Beneath an unassuming church on Via Veneto, six chapels decorated entirely with the bones of ~3,700 friars, and the sign: 'What you are now, we once were.'", wiki: "https://en.wikipedia.org/wiki/Capuchin_Crypt" },
  { id: "palazzospada", name: "Palazzo Spada perspective", type: "hall", secret: true, lat: 41.8952, lng: 12.4712, era: 8, status: "standing", date: "1653", blurb: "Borromini's dazzling optical trick: a colonnade that looks 37 m deep is really only 8, its far 'life-size' statue barely knee-high.", wiki: "https://en.wikipedia.org/wiki/Palazzo_Spada" },
  { id: "protestant",  name: "Protestant Cemetery",        type: "statue", secret: true, lat: 41.8760, lng: 12.4788, era: 9, status: "standing", date: "from 1716", blurb: "A hushed cypress garden by the Pyramid where Keats and Shelley lie, watched over by the weeping marble Angel of Grief.", wiki: "https://en.wikipedia.org/wiki/Protestant_Cemetery,_Rome" },
  { id: "turtlefountain", name: "Fontana delle Tartarughe", type: "fountain", secret: true, lat: 41.8931, lng: 12.4772, era: 8, status: "standing", date: "1588", blurb: "A jewel-like Renaissance fountain hidden in a quiet Ghetto square, where four bronze youths gently lift turtles into the water.", wiki: "https://en.wikipedia.org/wiki/Fontana_delle_Tartarughe" },
  { id: "cloaca",      name: "Cloaca Maxima outlet",       type: "catacomb", secret: true, lat: 41.8892, lng: 12.4802, era: 1, status: "ruin", date: "c. 600 BC", blurb: "The stone mouth of Rome's 2,600-year-old great sewer still gapes on the Tiber bank — one of the oldest engineering works on earth, and thousands pass it daily.", wiki: "https://en.wikipedia.org/wiki/Cloaca_Maxima" },
  { id: "tempietto",   name: "Tempietto del Bramante",     type: "dome", secret: true, lat: 41.8884, lng: 12.4632, era: 8, status: "standing", date: "1502", blurb: "Hidden in a monastery courtyard on the Janiculum, Bramante's tiny circular temple is held to be the perfect built expression of the Renaissance.", wiki: "https://en.wikipedia.org/wiki/Tempietto" },
  { id: "coppede",     name: "Quartiere Coppedè",          type: "hall", secret: true, lat: 41.9192, lng: 12.4995, era: 9, status: "standing", date: "1919–1927", blurb: "A dreamlike pocket of fairytale Art-Nouveau architecture — turrets, gargoyles and a spider fountain — that almost no visitor ever finds.", wiki: "https://en.wikipedia.org/wiki/Quartiere_Copped%C3%A8" },
  { id: "sannicola",   name: "San Nicola in Carcere",      type: "church", secret: true, lat: 41.8912, lng: 12.4796, era: 7, status: "standing", date: "11th c.", blurb: "A medieval church wrapped around three ancient temples — their columns still poke through its walls, and you can walk the crypt among them.", wiki: "https://en.wikipedia.org/wiki/San_Nicola_in_Carcere" },
  { id: "santostefano", name: "Santo Stefano Rotondo",     type: "church", secret: true, lat: 41.8846, lng: 12.4956, era: 6, status: "standing", date: "AD 468–483", blurb: "One of the oldest round churches in the world, ringed with unnervingly graphic martyrdom frescoes — eerily quiet on the Caelian hill.", wiki: "https://en.wikipedia.org/wiki/Santo_Stefano_Rotondo" },
  { id: "keatsshelley", name: "Keats-Shelley House",       type: "hall", secret: true, lat: 41.9058, lng: 12.4820, era: 9, status: "standing", date: "1821", blurb: "The little house at the foot of the Spanish Steps where the poet Keats died at 25 — a museum the crowds hurry straight past on their way up.", wiki: "https://en.wikipedia.org/wiki/Keats%E2%80%93Shelley_Memorial_House" },
  { id: "argentari",   name: "Arch of the Money-changers", type: "arch", secret: true, lat: 41.8892, lng: 12.4831, era: 5, status: "standing", date: "AD 204", blurb: "A small, richly carved arch raised by the money-changers for Septimius Severus, tucked against a church in the old cattle market.", wiki: "https://en.wikipedia.org/wiki/Arch_of_the_Argentarii" },
  { id: "passetto",    name: "Passetto di Borgo",          type: "gate", secret: true, lat: 41.9025, lng: 12.4608, era: 7, status: "standing", date: "1277", blurb: "The pope's secret escape route — an elevated walled corridor from the Vatican to Castel Sant'Angelo, used to flee the 1527 Sack of Rome.", wiki: "https://en.wikipedia.org/wiki/Passetto_di_Borgo" },
